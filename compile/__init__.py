...
clean_directory(settings.NRI_DIR, force_delete=False)
clean_directory(settings.ROSTER_DIR, force_delete=False)
clean_directory(settings.DEPTH_DIR, force_delete=False)
clean_directory(settings.GAME_DIR, force_delete=False)
clean_directory(settings.GAME_DIR, force_delete=False)
