...
p_splits.loc[p_splits['mlb_id'] == 669735, ['name','fd_wpa_b_vr', 'fd_wpa_b_vl', 'batters_faced_vl', 'pitches_start']]
p_splits.loc[p_splits['mlb_id'] == 607200, ['name','fd_wps_b_vr', 'fd_wps_b_vl', 'batters_faced_vl', 'pitches_start']]


venue = (game_data['venue_id'] == 2394)
temp_g =(game_data['temp'] > 75)
temp_l = (game_data['temp'] < 85)
wind_l = (game_data['wind_speed'] < 10)
wind_g = (game_data['wind_speed'] > 10)
...
filtered_venue = game_data[(venue
