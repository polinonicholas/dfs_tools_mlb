...
lineups = s.build_lineups(
    ...
    custom_stacks={"white sox": 1},
    custom_pitchers=None,
    custom_secondary={"reds": 1},
...
second = s.second_df[cols_of_interest].sort_values(
